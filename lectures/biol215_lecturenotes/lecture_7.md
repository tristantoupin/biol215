...
| Angiosperms | <ul><li>They advertise their sex organs for all to see (like a flower).</li><li>95% of amodern plants are Angiosperms.</li><li>The major invention is the flower.</li><li>The Angiosperms have  complex cycle of life (see image beside).</li></ul> |![alt text](lecture_data/Angiosperms_1.png "Flower anatomy") ![alt text](lecture_data/Angiosperms_2.png "Complexe life cycle of a plant") ![alt text](lecture_data/Angiosperms_3.png "Flower") |
